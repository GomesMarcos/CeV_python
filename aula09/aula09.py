...
print(frase.count('o', 0 , 13)) #Quantas vezes aparece o char 'o' entre o índice 0 a 12
...
# Transformação
print(frase.replace('Python', 'Android')) #Substitui a primeira substring pela segunda
print(frase.upper())
print(frase.lower())
print(frase.capitalize())
print(frase.title()) #Analisa quantas palavras a string possui e torna a primeira letra de cada maiúscula

frase = '   Aprenda Python  '
print(frase.strip()) #Remove os espaços no início e no final da string
print(frase.rstrip()) #Remove os espaços ndireita da string
print(frase.lstrip()) #Remove os espaços nna esquerda da string

# Divisão
frase = 'Curso em Vídeo Python'
print(frase.split()) #Divide a string, tendo como parâmetro padrão os espaços entre as letras,
